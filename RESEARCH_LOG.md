...
| fB2-osc0-1 | 2026-08-20 | char-osc0 | 6,38M | 2,2B byte | 1 | 0,3960 | Asintoto B2: gap vs cb +0,008 = identico a 700M → **pendenze parallele** (parità strutturale, come stadio 1) |
...
| fC1-ts-1 | 2026-08-20 | char-hyb-ts | 6,39M | 700M byte | 1 | 0,4357 | **C1: la gerarchia di sole timescale vale 2/3 del vantaggio di hard** (0,017 dei 0,026 su lti32) — baseline Harmonic parzialmente replicata; hard tiene +0,009 (~1,3σ, ambiguo → s2). 32-true dopo NaN a 16-mixed (bande lente quasi-DC, stessa fisica di hard) |
